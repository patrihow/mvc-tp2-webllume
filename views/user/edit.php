...
<section class="form-section">
    <form method="post" class="user-form">
        ...
        <div class="form-group">
            ...
            <input type="password" name="mot_de_passe" id="mot_de_passe" placeholder="Entrez un mot de passe qui contient des chiffres et des lettres" class="form-input" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nom" id="nom" placeholder="Entrez votre nom" value="{{ user.nom }}" class="form-input" required>
        ...
        <div class="form-group">
            ...
            <select name="user_privileges_id" id="user_privileges_id" class="form-select" required>
                ...
                {% for privilege in privileges %}
                    <option value="{{ privilege.id }}" {% if privilege.id == user.user_privileges_id %}selected{% endif %}>{{ privilege.nom }}</option>
                {% endfor %}
            </select>
        </div>
        <div class="form-group">
            <button type="submit" class="bouton">Modifier le compte</button>
        </div>
    </form>
</section>
