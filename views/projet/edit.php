{{ include('layouts/header.php', {title: 'Modifier le Projet'}) }}
<main>
    <section class="grille">
        <section class="form-section">
            ...
            <form action="projet-update.php?id={{ projet.id }}" method="POST" enctype="multipart/form-data" class="projets-form">
                <div class="form-group">
                    <label for="titre" class="form-label">Titre du Projet</label>
                    <input type="text" id="titre" name="titre" placeholder="Entrez le titre du projet" value="{{ projet.titre }}" class="form-input" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Entrez la description du projet" class="form-textarea" rows="15" required>{{ projet.description }}</textarea>
                ...
                <div class="form-group">
                    <button type="submit" class="form-button">Modifier le Projet</button>
                </div>
            </form>
            <div><a href="index.php">Retour à la liste des projets</a></div>
        </section>
    </section>
</main>
